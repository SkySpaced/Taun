...
Steps to allocate more:
    ...
    Hover over your 1.8.9 Forge profile, click the three dots, and choose Edit.
    Click More Options at the bottom.
    Find the JVM Arguments section. The first argument controls RAM, and looks like this:
